...
STATIC_URL = os.path.join('http://http://desa-1.herokuapp.com',BASE_DIR, 'static/')
#STATIC_ROOT = '/static/'
STATIC_ROOT =  os.path.join('http://http://desa-1.herokuapp.com',BASE_DIR, 'static/')
...
TEMPLATE_DIRS = [os.path.join(BASE_DIR, 'templates1')]
